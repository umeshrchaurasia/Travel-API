...
class BatchPayment_bajajController {

     // Get proposal details by agent and payment status
    async getProposalDetailsByAgent_bajaj(req, res) {
        try {
            ...
            const [rows] = await db.query(
                'CALL GetProposalDetailsByAgent_bajaj(?, ?)',
    ...
    async insertBatchPayment_bajaj(req, res) {
        try {
            ...
            // Call the stored procedure
             const [rows] = await db.query(
                'CALL InsertBatchPayment_Agent_bajaj(?, ?, ?, ?, ?)',
            ...
            logger.error('InsertBatchPaymentBajaj error:', error);
            base.send_response(
    ...
    async getBatchPaymentsByStatus_bajaj(req, res) {
        try {
            ...
            // Call stored procedure
            const [rows] = await db.query(
                'CALL GetBatchPaymentsByAdminApproval_bajaj(?)',
                [status]
            );
    ...
    async updateBatchPayment_bajaj(req, res) {
        try {
            ...
            try {
                ...
                const [results] = await db.query(
                    'CALL UpdateBatchPayment_SP_bajaj(?, ?, ?, ?)',
...
module.exports = new BatchPayment_bajajController();