...
class InvoicePractoService {
    constructor() {
        this.pdfStorePath = './public/invoicesPracto/';
    ...
    ensureDirectories() {
        try {
            ...
            const sourceTemplate = path.join(__dirname, '../views/tax-invoice-inter_practo.ejs');
            const destTemplate = path.join(this.templatesPath, 'tax-invoice-inter_practo.ejs');
            ...
            const sourceUpfrontTemplate = path.join(__dirname, '../views/tax-invoice-inter_upfront_practo.ejs');
            const destUpfrontTemplate = path.join(this.templatesPath, 'tax-invoice-inter_upfront_practo.ejs');
    ...
    async generateInvoicePracto(custId, invoiceData, policyLogoBase64, signatureBase64, callback) {
        ...
        try {
            ...
            const pdfUrl = `/invoicesPracto/Invoice${custId}.pdf`;
            ...
            const templateFileName = processed.Paymentmode === 'Upfront Commission'
                ? 'tax-invoice-inter_upfront_practo.ejs'
                : 'tax-invoice-inter_practo.ejs';
    ...
    generateHtmlOnly(custId, invoiceData, policyLogoBase64, signatureBase64, callback) {
        ...
        try {
            ...
            let templateFileName = 'tax-invoice-inter_practo.ejs'; // Default template
            if (processed.Paymentmode === 'Upfront Commission') {
                templateFileName = 'tax-invoice-inter_upfront_practo.ejs';
            }
...
module.exports = new InvoicePractoService();