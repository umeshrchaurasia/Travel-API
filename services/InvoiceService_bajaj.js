...
class InvoiceService_bajaj {
    constructor() {
        this.pdfStorePath = './public/invoicesBajaj/';
    ...
    ensureDirectories() {
        try {
            ...
            const sourceTemplate = path.join(__dirname, '../views/tax-invoice-inter_bajaj.ejs');
            const destTemplate = path.join(this.templatesPath, 'tax-invoice-inter_bajaj.ejs');
            ...
            const sourceUpfrontTemplate = path.join(__dirname, '../views/tax-invoice-inter_upfront_bajaj.ejs');
            const destUpfrontTemplate = path.join(this.templatesPath, 'tax-invoice-inter_upfront_bajaj.ejs');
    ...
    async generateInvoicebajaj(custId, invoiceData, policyLogoBase64, signatureBase64, callback) {
        ...
        try {
            ...
            const pdfUrl = `/invoicesBajaj/Invoice${custId}.pdf`;
...
module.exports = new InvoiceService_bajaj();